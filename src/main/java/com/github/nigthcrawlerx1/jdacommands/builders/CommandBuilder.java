...
import com.github.nigthcrawlerx1.jdacommands.commands.exception.CommandSetException;
...
public class CommandBuilder {
    ...
    private final String INVALID_PREFIX_MESSAGE = "O prefixo não pode estar vazio ou conter os caracteres +*^|$\\?";
    private final String INVALID_LABEL_MESSAGE = "A etiqueta não pode estar vazia, consistir em várias palavras ou conter novas linhas!";
     ...
     *                       "FOO", "FoO" and so on.
     */
    public CommandBuilder(@Nonnull String defaultPrefix, @Nonnull ShardManager shardManager, boolean labelIgnoreCase) {
     ...
     *                        "FOO", "FoO" and so on.
     */
    public CommandBuilder(@Nonnull String defaultPrefix, @Nonnull JDA jda, boolean labelIgnoreCase) {
        this(defaultPrefix, labelIgnoreCase);
        this.jda = jda;
        this.useShardManager = false;
    }

    private CommandBuilder(@Nonnull String defaultPrefix, boolean labelIgnoreCase) {
     ...
     */
    @Deprecated
    public CommandBuilder clearHelpLabels() {
     ...
     * @return The current object. This is to use fluent interface.
     */
    public CommandBuilder addChannelToBlacklist(long channelId) {
     ...
     * @return The current object. This is to use fluent interface.
     */
    public CommandBuilder addChannelsToBlacklist(long... channelIds) {
     ...
     * @return The current object. This is to use fluent interface.
     */
    public CommandBuilder addChannelsToBlacklist(Collection<Long> channelIds) {
     ...
     * @return The current object. This is to use fluent interface.
     */
    public CommandBuilder clearBlacklist() {
     ...
     */
    public CommandBuilder put(@Nonnull ICommand executor, String label) {
        if (label.matches(VALID_LABEL))
     ...
     */
    public CommandBuilder put(@Nonnull ICommand executor, @Nonnull String... labels) {
        for (String label : labels)
     ...
     */
    public CommandBuilder put(@Nonnull ICommand executor, @Nonnull Collection<String> labels) {
     ...
     * @return The current object. This is to use fluent interface.
     */
    public CommandBuilder clearCommands() {
        this.commands.clear();
        return this;
    }
     ...
     */
    public CommandBuilder setDefaultPrefix(@Nonnull String prefix) {
     ...
     * @see MessageBuilder
     */
    public CommandBuilder setUnknownCommandMessage(@Nullable Message message) {
        if (message == null)
     ...
     * @throws CommandSetException if a non-null prefix does not match the requirements for a valid prefix.
     */
    public CommandBuilder setCustomPrefix(long guildId, @Nullable String prefix) {
     ...
     */
    public CommandBuilder setCustomPrefixes(@Nonnull Map<Long, String> guildIdPrefixMap) {
     ...
     * @return The current object. This is to use fluent interface.
     */
    public CommandBuilder clearCustomPrefixes() {
     ...
     * @return The current object. This is to use fluent interface.
     */
    public CommandBuilder setCooldown(long msCooldown) {
     ...
     * @return The current object. This is to use fluent interface.
     */
    public CommandBuilder setResetCooldown(boolean resetCooldown) {
     ...
     * @return The current object. This is to use fluent interface.
     */
    public CommandBuilder setBotExecution(boolean botExecution) {
     ...
     * Note that activating multiple CommandBuilder may cause problems. You can do this to use multiple prefixes, but it is not recommended.<p>
    ...
    public void activate() {
        if (!this.activated) {
            ...
            this.activated = true;
            LOGGER.info("CommandSettings foram ativados");
        } else
            throw new CommandSetException("CommandSettings já ativado!", new IllegalStateException("Não é possível ativar CommandSettings no estado atual\n"));
    }
    ...
    public void deactivate() {
        if (this.activated) {
            ...
            this.activated = false;
            LOGGER.info("CommandSettings foram desativados");
        } else
            throw new CommandSetException("As CommandSettings ainda não foram ativadas e, portanto, não podem ser desativadas!", new IllegalStateException("Não é possível desativar CommandSettings no estado atual"));
    }
    ...
    public Map<String, ICommand> getCommand() {return commands;}
